...
/** Sticky floating WhatsApp button, bottom-right on mobile. */
export function MobileWhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-40 inline-flex items-center gap-2 rounded-full bg-[#1FAA55] px-4 py-3 text-sm font-semibold text-white shadow-lg shadow-black/20 transition-transform hover:-translate-y-0.5 lg:hidden"
    >
