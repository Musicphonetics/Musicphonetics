            ...
            <Reveal key={p.img} delay={(i % 3) * 90}>
              <figure className="flex flex-col items-center">
                <div className="relative w-full max-w-[220px]">
                  <div className="overflow-hidden rounded-[1.6rem] border-[5px] border-[#0b0e15] bg-[#0b0e15] shadow-[0_30px_70px_-30px_rgba(22,27,38,0.5)]">
                ...
                <figcaption className="mt-4 text-center text-sm text-ivory/65">{p.caption}</figcaption>
              </figure>
            </Reveal>
          ))}
        </div>
