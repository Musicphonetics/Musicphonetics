        ...
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          <Reveal>
            <div className="relative mx-auto w-full max-w-[280px]">
              ...
              <div className="relative rounded-[2.2rem] border-[6px] border-ink bg-ink p-1 shadow-[0_40px_90px_-30px_rgba(22,27,38,0.5)]">
          ...
          <div>
            <Reveal>
              <div className="flex items-center gap-3">
                ...
                <span className="text-[0.75rem] font-semibold uppercase tracking-[0.16em] text-[#7A5E0F]">Your parent portal</span>
              </div>
              <h2 className="mt-4 font-display text-[clamp(1.7rem,4.5vw,2.4rem)] font-medium leading-tight text-ink">
                Know exactly how your child is doing.
              </h2>
              <p className="mt-3 max-w-md text-[0.95rem] leading-relaxed text-ink/65 sm:text-base">
              ...
              <ul className="mt-6 space-y-3.5">
                {INSIDE.map((x) => (
                  <li key={x.t} className="flex items-start gap-3">
                    <span className="mt-0.5 grid h-6 w-6 shrink-0 place-items-center rounded-full bg-gold/15 text-[#7A5E0F]">
                    ...
                    <span>
                      <span className="block text-[0.95rem] font-semibold text-ink">{x.t}</span>
                      <span className="block text-sm text-ink/60">{x.d}</span>
                    </span>
                  </li>
                ))}
              </ul>
