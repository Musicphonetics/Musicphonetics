    ...
    <section className="bg-onyx py-16 text-paper sm:py-28">
      <div className="container-mp">
        <div className="grid items-center gap-10 lg:grid-cols-[0.8fr_1fr] lg:gap-16">
          {/* Photo */}
          <Reveal>
            <figure className="relative mx-auto max-w-sm overflow-hidden rounded-3xl border border-white/10 shadow-[0_20px_60px_-20px_rgba(0,0,0,0.8)] lg:mx-0">
          ...
          <div>
            <Reveal>
              ...
              <blockquote className="mt-5 font-display text-[clamp(1.5rem,3vw,2.2rem)] font-medium leading-[1.2] text-paper">
            ...
            <Reveal delay={100}>
              ...
              <p className="mt-6 font-display text-base font-semibold text-gold">- Abhishek Kumar, Founder &amp; Director</p>
              <Link href="/founder" className="mt-2 inline-block text-sm font-semibold text-gold underline-offset-4 hover:underline">
