        ...
        <div className="grid items-center gap-10 lg:grid-cols-[0.85fr_1fr] lg:gap-16">
          ...
          <Reveal>
            <div className="relative mx-auto max-w-sm lg:mx-0">
              ...
              <figure className="absolute -bottom-5 -right-4 hidden w-32 overflow-hidden rounded-2xl border-4 border-charcoal-2 shadow-xl sm:block">
          ...
          <div>
            ...
            <Reveal delay={100}>
              ...
              <div className="mt-5 flex flex-wrap gap-2">
                {CHIPS.map((c) => (
                  <span key={c} className="rounded-full border border-white/12 bg-white/5 px-3 py-1.5 text-[0.78rem] font-medium text-ivory/75">{c}</span>
                ))}
              </div>
