...
export function CentreEvents() {
  return (
    <section id="whats-next" className="bg-mist py-14 text-ink sm:py-20">
      <div className="container-mp">
        ...
        <div className="mt-10 grid gap-5 lg:grid-cols-2">
          {/* South Delhi centre */}
          <Reveal>
            <div className="flex h-full flex-col rounded-3xl border border-hairline bg-white shadow-card p-7 sm:p-8">
              ...
              <h3 className="mt-5 font-display text-2xl font-semibold text-ink">The South Delhi centre</h3>
              ...
              <div className="mt-6">
                <WhatsAppCTA label="Ask about the centre" message={WA_MSG.events} variant="outline" className="!border-ink/25 !text-ink hover:!border-ink" />
              </div>
            </div>
          </Reveal>
          ...
          <Reveal delay={90}>
            <div className="flex h-full flex-col rounded-3xl border border-gold/40 bg-gradient-to-b from-gold/[0.10] to-white/[0.02] p-7 sm:p-8">
              ...
              <h3 className="mt-4 font-display text-2xl font-semibold text-ink">Open Mic &amp; Chai + student showcases</h3>
