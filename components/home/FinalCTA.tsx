...
export function FinalCTA() {
  return (
    <section className="relative overflow-hidden bg-onyx py-16 text-paper sm:py-28">
      ...
      <div className="container-mp relative">
        <Reveal>
          <div className="mx-auto max-w-xl text-center">
            ...
            <p className="mx-auto mt-4 max-w-md text-base leading-relaxed text-paper/75">
            ...
            <p className="mt-4 text-sm text-paper/55">We reply immediately.</p>
          </div>
        </Reveal>
      </div>
    </section>
