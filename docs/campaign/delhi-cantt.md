...
> Main Pathway — first month *₹10,000* instead of ~₹15,000~ (save ₹5,000), then ₹15,000/month.
...
2. **Files created:**
   ...
   The page also shows a **three-programme comparison** (Foundation ₹10,000 · Main Pathway ₹15,000 · Director’s Circle by consultation) so families can understand the full range and enquire about any of them — the Delhi Cantt benefit is clearly scoped to the **Main Pathway, first month only**.
...
12. **Manual steps remaining:**
    ...
    - Offer terms are set to **first month ₹10,000, then ₹15,000/month** (matches the poster). All copy is centralised in `lib/delhi-cantt.ts` if terms change.
